...
/// Mica/Acrylic 背景 + 角丸 + ダークモードを DWM で適用 (SPEC 6.5)
fn apply_window_effects(cc: &eframe::CreationContext<'_>, dark: bool) {
    ...
    unsafe {
        // DWMSBT_TRANSIENTWINDOW = Acrylic (ポップアップ向けマテリアル)
...
/// 戻り値は egui の論理ポイント
fn popup_position(width_pt: f32, height_pt: f32) -> Pos2 {
